...
Tο υποσύστημα αυτό αναλαμβάνει την επικοινωνία και τον έλεγχο συσκευών που ελέγχονται μέσω προτοκόλλου υπερύθρων (IR protocol) ή με άλλα λόγια σθσκευών πολυμέσων που έχουν τηλεχειριστήριο.Δεν λειτουρεί αυτόνομα αλλά σε σύνδεση με έναν απο τους σταθμούς τύπου Γ ή Δ.Στην ουσία μεταφράζει τα μηνύματα **Mqtt** που λαμβάνει ο ελεγχτής σταθμός σε αντίστοιχες εντολές του IR protocol της συσκευής που πρέπει να ελεγχεί και μετά τις μεταδίδει μέσω της διόδου υπερύθρων **IR  LED transmitter**  
