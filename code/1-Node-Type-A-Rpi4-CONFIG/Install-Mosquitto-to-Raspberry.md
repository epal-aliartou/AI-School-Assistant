## Εγκατάσταση Mosquitto στο Raspberry Pi 4 (Κεντρικός server του «Αυτόματου Σχολικού Βοηθού» του Σχολείου)
...
Εκτελέστε την ακόλουθη εντολή για να δημοσιεύσετε το μήνυμα " `EPAL KALHMERA`" στον `localhost`διακομιστή μας στο `mqtt/pimylifeup`θέμα " ".
