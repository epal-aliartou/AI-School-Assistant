...
Πριν προχωρήσετε, ίσως αξίζει να ρυθμίσετε το [Raspberry Pi σας με μια στατική διεύθυνση IP](https://pimylifeup.com/raspberry-pi-static-ip-address/) .
...
Ευτυχώς για εμάς, ο μεσίτης Mosquitto MQTT είναι διαθέσιμος ως μέρος του [αποθετηρίου Raspbian](https://pimylifeup.com/raspbian-repository-mirror/) , οπότε η εγκατάσταση του λογισμικού είναι απλή.
